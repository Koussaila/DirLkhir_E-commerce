...
<head>
<script data-ad-client="ca-pub-5824582124599732" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
<title><?php echo $site_title; ?> - Site de don d'objets</title>
...
<div class="navbar-header">
	<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#main-navbar" 	aria-controls="main-navbar" aria-expanded="false" aria-label="Toggle navigation">
		...
		<span class="lni-menu"></span>
		<span class="lni-menu"></span>
	</button><a href="./" id="site_logo"  class="navbar-brand"><?php echo $site_title; ?></a>
			</div>
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-9 col-xs-12 text-center">
					<div class="contents">
						<h1 class="head-title">Donner plutôt que jeter</h1>
						<p>Recyclage, entraide et partage sont les devises qui opèrent sur le site.</p>
...
<div class="row">
<div class="col-12">
<h3 class="section-title">Comment donner un objet sur le site ?</h3>
</div>
...
<p>Publier un objet gratuitement</p>
</div>
</div>
<div class="col-lg-4 col-md-4 col-xs-12">
<div class="works-item">
