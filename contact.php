...
<title><?php echo $site_title; ?> - Nous contacter</title>
...
<li style="color:white;" class="current">Nous contacter</li>
</ol>
</div>
</div>
</div>
...
<div class="col-lg-8 col-md-8 col-xs-12">
							...
							<h2 class="contact-title">Envoie-nous un message</h2>
							<div class="row">
							<div class="col-md-12">
							...
							<input type="text" class="form-control" id="name" required name="name" placeholder="Nom" required data-error="Veuillez entrer votre Mom">
							<div class="help-block with-errors"></div>
							</div>
							</div>
							<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group">
							<input type="email" name="email" class="form-control" id="email" required placeholder="E-mail" required data-error="Veuillez entrer votre Email">
							<div class="help-block with-errors"></div>
							</div>
							</div>
							<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
							...
							<div class="col-md-12">
							<div class="form-group">
							<textarea class="form-control" placeholder="Massage" name="message" required rows="7" data-error=" Veuillez rédiger votre message" required></textarea>
							<div class="help-block with-errors"></div>
							</div>
							</div>
							</div>
							...
							<div class="col-md-12">
							<button type="submit"  class="btn btn-common">Soumettre maintenant</button>
