...
<div class="post-btn">
    <?php
	if ($logged == "1") {
		print '<a class="btn btn-common" href="upload"><i class="lni-pencil-alt"></i>Ajouter une annonce</a>';
...
<li class="current" style="color:white">Ajouter une annonce</li>
</ol>
</div>
</div>
</div>
...
<h2 class="dashbord-title">Votre annonce</h2>
</div>
<div class="dashboard-wrapper">
  <form action="app/new-ad.php" method="POST" autocomplete="off" onsubmit="var text = document.getElementById('minle').value; if(text.length < 1) { alert('La description doit contenir au moin un seul caractere'); return false; } return true;">
<div class="form-group mb-3">
<label class="control-label">Titre</label>
<input class="form-control input-md" name="title" placeholder="Entrez un titre de l'annonce " required type="text">
</div>
...
<input class="form-control input-md" name="brand" placeholder="Entrez une marque" type="text">
</div>

<div class="form-group mb-3">
<label class="control-label">Description</label>
<textarea  id="minle" class="form-control input-md" name="shortdesc" required></textarea>
</div>
