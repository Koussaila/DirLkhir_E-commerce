...
<h2><a>Annonces postées </a></h2>
<h3><?php echo number_format($total_ads); ?> Annonces postées </h3>
</div>
</div>
</div>
<div class="col-xs-6 col-sm-6 col-md-6 col-lg-4">
...
<div class="contentbox">
<h2><a>Annonces actuelles</a></h2>
<h3><?php echo number_format($active_ads); ?> Annonces actuelles</h3>
</div>
</div>
</div>
<div class="col-xs-6 col-sm-6 col-md-6 col-lg-4">
...
<div class="contentbox">
<h2><a>Annonces en attentes</a></h2>
<h3><?php echo number_format($pending_ads); ?> Annonces en attentes</h3>
</div>
</div>
</div>
</div>
...
<div class="dashboard-box">
<h2 class="dashbord-title">Paramètres du profil</h2> <br></br>
<h10 class="dashbord-title">Mettre à jour mes coordonées
</h10>
</div>
...
<button class="btn btn-common" type="submit">Mettre à jour
</button>
</form>
</div>
...
<h10 class="dashbord-title">Mettre à jour mon mot de passe
</h10>
</div>
...
<input class="form-control input-md" name="confirmpassword" placeholder="Confirmez votre nouveau mot de passe" required type="password">
<div class="tg-checkbox mt-3">
</div>
</div>

<button class="btn btn-common" onclick="return val_a();"  type="submit">Mettre à jour</button>
</form>
</div>
...
<div class="dashboard-box">
<h10 class="dashbord-title">Mettre à jour mon Avatar </h10>
</div>
...
<button class="btn btn-common" type="submit">Mettre à jour</button>
<?php
if ($myavatar == null) {

}else{

	print '<a'; ?> onclick = "return confirm('etes-vous sur de vouloir supprimer l'avatar ?');"  <?php print ' class="btn btn-common" href="app/drop-dp.php?lnk='.base64_encode($myavatar).'">Supprimer l\'image</a>';
