...
<title><?php echo $site_title; ?> Annonces en attentes</title>
...
<h2 class="product-title">Annoces en attente</h2>
<ol class="breadcrumb">
<li><a href="../">Acceuil /</a></li>
<li class="current" style="color:white">Annonces en attentes</li>
</ol>
</div>
</div>
</div>
...
<h2 class="dashbord-title">Annonces en attentes </h2>
</div>
...
<a onclick = "return confirm('Etes-vous sûr que vous voulez supprimer?'); " class="btn-action btn-delete" href="app/drop-ad.php?node=<?php echo base64_encode($row['ad_id']); ?>"><i class="lni-trash"></i></a>
</div>
</td>
</tr>
