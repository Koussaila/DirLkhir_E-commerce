...
<title><?php echo $site_title; ?> - Mot de passe oublié</title>
...
<h2 class="product-title">Mot de passe oublié</h2>
<ol class="breadcrumb">
<li><a href="./">Accueil /</a></li>
<li style="color:white;" class="current">Mot de passe oublié</li>
</ol>
</div>
</div>
</div>
...
<p>Veuillez saisir votre adresse e-mail ou nom d'utilisateur associé à votre compte, un lien pour réinitialiser le mot de passe sera envoyé à votre adresse e-mail</p><br>
<div class="form-group">
<div class="input-icon">
<i class="lni-user"></i>
<input type="text" class="form-control" name="user" required placeholder="Adresse e-mail ou Nom d'utilisateur">
...
<a class="forgetpassword" href="login">Retour connexion</a>
</div>


<div class="text-center">
<input id="btnSubmit" type="submit" value="Trouver mon compte" class="btn btn-common log-btn">
</div>
</form>
</div>
</div>
