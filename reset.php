...
<div class="input-icon">
<i class="lni-lock"></i>
<input type="password" name="confirmpassword" required class="form-control" placeholder="Re-taper le mot de passe">
</div>
</div>

<div class="text-center">
<input id="btnSubmit" type="submit"  onclick="return val_a();" value="Valider le mot de passe" class="btn btn-common log-btn">
</div>
</form>
<?php
