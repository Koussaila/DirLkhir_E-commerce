...
<title><?php echo $site_title; ?> - Créer un compte</title>
...
<li style="color:white;" class="current">Créer un compte</li>
</ol>
</div>
</div>
</div>
...
Inscription
                                  ...
                                  <i class="lni-user"></i>
                                  <input type="text" id="UserName" class="form-control" name="user_name" required placeholder="Nom" onkeyup="checkname();">
                                  ...
                                  <input type="email" id="UserEmail" class="form-control" name="user_email" required placeholder="Adresse E-mail" onkeyup="checkemail();">
                                  ...
                                  <div class="input-icon">
                                  <i class="lni-lock"></i>
                                  <input type="password" name="confirmpassword" required class="form-control" placeholder="Retaper le mot de passe">
                                  </div>
                                  </div>

                                  <div class="text-center">
                                  <input id="btnSubmit" type="submit"  onclick="return val_a();" value="S'inscrire" class="btn btn-common log-btn">
                                  </div>
                                  </form>
</div>
</div>
...
function checkname()
{
 ...
 if(name)
 {
  ...
  success: function (response) {
   ...
   if(response == '<div class="alert alert-warning">Ce nom d''utilisateur est déjà enregistré</div>')	
   {
...
function checkemail()
{
 ...
 if(email)
 {
  ...
  success: function (response) {
   ...
   if(response == '<div class="alert alert-warning">L''adresse E-mail est déjà utilisée</div>')	
   {
