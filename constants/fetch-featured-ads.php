...
try {
	...
	$stmt = $conn->prepare("SELECT * FROM tbl_ads LEFT JOIN tbl_users on tbl_ads.author = tbl_users.user_id WHERE tbl_ads.status = 'active' AND tbl_ads.featured = 'yes' ORDER BY enc_id DESC");
	$stmt->execute();
...
<div class="overlay">
<div>
<a class="btn btn-common" href="ad/<?php echo $row['ad_id']; ?>">Voir les détails</a>
</div>
</div>
